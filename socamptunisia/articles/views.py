...
from socamptunisia.decorators import ajax_required
import markdown
...
def addNotes(req):
    return render(req,"articles/addnotes.html")

def firechat(req):
    return render(req,"articles/chatfire.html")

def piano2(req):
    return render(req,"articles/piano2.html")
def myeditor(req):
    return render(req,"articles/editorhtml1.html")

def  piano1(req):
    return render(req,"articles/piano1.html")


def rubikGame(req):
    return render(req,"articles/rubikGame.html")

def mainCraft(req):
    return render(req,"articles/mainCraft.html")

def chatty(req):
    return render(req,"articles/chatty.html")
...
def addIndex(req):
    return render(req,"articles/dbindex.html")
